...
export { initDb, computeSHA256, createAuditLog, getAuditLogs, addAuditLogAdmin, getUserByCpf, createUser, updateUserPassword, authenticateUser, getLoginAttempts, recordLoginAttempt, clearLoginAttempts, updatePatientUser, getAllUsersForAdmin, deleteUserAdmin, updateUserAdmin, createDonation, updateDonation, getDonationsByCpf, getDonorPoints, addDonorPoints, redeemDonorBadge, triggerDonorPrestige, saveSupportMessage, getSupportMessages, createRecurringSubscription, getRecurringSubscriptionsByCpf, updateRecurringSubscription, deleteRecurringSubscription, getTransparencyData, saveTransparencyData };
