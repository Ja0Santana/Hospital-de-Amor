...
import { 
  ...
  Shield, AlertTriangle, CheckCircle2, History, ShieldCheck,
    ...
    const loadUserData = async () => {
      ...
      try {
        ...
        if (patient) {
          ...
          setIsEmailNotify(patient.privacyPreferences?.emailNotify ?? true);
          setIsSmsNotify(patient.privacyPreferences?.smsNotify ?? false);
          setIsWhatsappNotify(patient.privacyPreferences?.whatsappNotify ?? true);
          setIsNpsNotify(patient.privacyPreferences?.npsNotify ?? true);
          setIsNewsletterNotify(patient.privacyPreferences?.newsletterNotify ?? false);
          setIsMarketingNotify(patient.privacyPreferences?.marketingNotify ?? false);
