                      ...
                      {user.cpf === loggedEmployeeCpf ? (
                        ...
                        <button
                          ...
                          className={`inline-flex items-center gap-1 h-8 px-3 rounded-xl border font-bold transition-all shadow-xs ${
                            user.isActive !== false
                              ? 'border-red-200 bg-white hover:bg-red-50 hover:text-red-700 hover:border-red-350 text-zinc-650 dark:bg-zinc-955 dark:border-red-950/40 dark:hover:bg-red-955/25 dark:text-red-450'
